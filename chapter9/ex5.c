 ...
 * structure as defined in this chapter.The function should call the timeUpdate function,
 * and if the time reaches midnight, the function should call the dateUpdate
